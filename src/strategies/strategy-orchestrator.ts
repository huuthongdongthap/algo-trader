...
export interface StrategyConfig {
  id: string;
  name: string;
  type: 'polymarket-arb' | 'polymarket-mm' | 'grid' | 'dca' | 'funding-arb' | 'book-imbalance' | 'vwap-sniper' | 'pairs-stat-arb' | 'session-vol-sniper' | 'orderbook-depth' | 'cross-event-drift' | 'vol-compression';
  enabled: boolean;
